...
import { QrCode, EyeOff, Eye, ArrowLeft, Loader2 } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    // Redirect to home and refresh so the Navbar updates with user info
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#e6193c] flex-col justify-center items-center relative overflow-hidden">
        ...
        <div className="z-10 text-center px-12">
          ...
          <h1 className="text-white text-3xl font-medium tracking-wide font-[family-name:var(--font-playfair)]">
            The leading fashion destination <br />
            for modern trendsetters
          </h1>
        </div>
      </div>
        ...
        <div className="bg-white w-full max-w-md p-8 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-xl relative">
          ...
          <form className="space-y-4" onSubmit={handleEmailLogin}>
            ...
            <div className="flex justify-between items-center text-sm pt-2">
              <a href="#" className="text-[#0055AA] hover:underline">Forgot Password</a>
            </div>
          </form>
