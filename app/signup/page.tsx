            ...
            <form className="space-y-4" onSubmit={handleVerifyOtp}>
              ...
              <div>
                <input 
                  ...
                  className="w-full border border-gray-300 rounded p-4 text-center text-xl font-bold tracking-[0.5em] focus:outline-none focus:border-[#e6193c] focus:ring-1 focus:ring-[#e6193c] transition-colors"
                  maxLength={6}
                />
              </div>
              <button 
