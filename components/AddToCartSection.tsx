    ...
    <div className="mt-8">
              ...
              return (
                <button
                  ...
                  className={`py-3 text-sm font-medium rounded-md border flex items-center justify-center transition-colors
                    ${!isAvailable ? 'bg-gray-50 border-gray-100 text-gray-300 cursor-not-allowed' : 
      ...
      <button
        ...
        className={`w-full py-4 rounded-full text-sm font-bold tracking-widest uppercase transition-colors
          ${(!isGuest && isOutOfStock) ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-[#e6193c] text-white hover:bg-[#c41432]'}
        `}
      >
